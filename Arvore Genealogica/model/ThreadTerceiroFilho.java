  ...
  */
  ...
  public void run(){
    ...
    for(idade = 0; idade <=55; idade++){
      ...
      if(idade >=4 && idade<=15){
        cT.trocaFazeVidaTFilho("./view/crianca.png");//Alteracao da imagem do ente no ImageView
      }
      if(idade>=16 && idade <=55){
        if(idade == 55){
          cT.trocaFazeVidaTFilho("./view/lapide.png");//Alteracao da imagem do ente no ImageView
